...
export default function Bio() {
    return (
        <Box component="main" sx={{ 
            ...
            <Toolbar />
            <Typography sx={{ mx: { xs: 3, md: 10 }, mb: {xs: 5,}, fontSize: {xs: 22, sm: 22, md: 30, lg: 34} }} variant='body2' align="center" paragraph>
            ...
            <Typography sx={{ mx: { xs: 3, md: 10 }, fontSize: {xs: 14, md: 20} }} variant='body2' align="center" paragraph>
            ...
            <Typography sx={{ mx: { xs: 3, md: 10 }, fontSize: {xs: 14, md: 20} }} variant='body2' align="center" paragraph>
                As a technically-minded person, understanding the nuts and bolts of how things work at the most fundamental level is something that I've always gravitated towards. During my time as a consultant, I worked closely with developers on tasks like writing technical documentation and translating client needs into specs, which inspired an even greater curiousity and desire to venture into software development. After a few years of self-study and exploration, I decided to make it my career.
            </Typography>
            <Typography sx={{ mx: { xs: 3, md: 10 }, fontSize: {xs: 14, md: 20} }} variant='body2' align="center" paragraph>
